...
// Khai bao OBJ Review product popup
const popup_ReviewProduct_OBJ = document.querySelector(".PreviewProductPopUp");
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // get OBJ submit your review button
    let SubmitReviewButton = document.querySelector(".home .frame-185-product-info-page .btn-submit-your-review");
    // get OBJ close Close-ReviewProduct-Popup
    let CloseReviewProductPopup = document.querySelector(".PreviewProductPopUp .popup-review-product__content .popup-review-product__close");
    ...
    let PaymentPageRedirects = document.querySelector(".home .frame-185-product-info-page .frame-524");
    PaymentPageRedirects.addEventListener("click", function() {
    ...
    // Về trang chủ khi nhấn vào logo trên nav bar
    ...
    SubmitReviewButton.addEventListener("click", function() {
        showPopup(popup_ReviewProduct_OBJ); // Hiển thị review product popup 
    });
    CloseReviewProductPopup.addEventListener("click", function() {
        hidePopup(popup_ReviewProduct_OBJ);  // hide review product popup 
    });
    ...
    // sự kiện giảm số lượng sản phẩm in quantity
    document.querySelector(".home .frame-185-product-info-page .Minus").addEventListener("click", function() {
        let QuantityProductOBJ = document.querySelector(".home .frame-185-product-info-page .Number-of-products");
    ...
    // sự kiện tăng số lượng sản phẩm in quantity
    document.querySelector(".home .frame-185-product-info-page .Plus").addEventListener("click", function() {
        let QuantityProductOBJ = document.querySelector(".home .frame-185-product-info-page .Number-of-products");
        if(isIntegerConvertible(QuantityProductOBJ.innerHTML) == true)
        {
            let QuantityProduct = Number.parseInt(QuantityProductOBJ.innerHTML);
