...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let ProductInformationPageRedirects = document.querySelectorAll(".home .card-product-in-roduct-list-frame");
    for(let i = 0; i<ProductInformationPageRedirects.length ; i++){
        ProductInformationPageRedirects[i].addEventListener("click", function() {
            window.location = domain + "Product-information-page.html";
        });
    }
